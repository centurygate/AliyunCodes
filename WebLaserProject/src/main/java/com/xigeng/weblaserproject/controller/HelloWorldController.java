package com.xigeng.weblaserproject.controller;
...
import com.xigeng.weblaserproject.model.*;
import com.xigeng.weblaserproject.service.*;
import com.xigeng.weblaserproject.springsecurity.MyJdbcDaoImpl;
import com.xigeng.weblaserproject.springsecurity.MyPasswordEncoder;
...
/*        try
        ...
        Double val =  Double.parseDouble(String.format("%.2f",measure.getDistance()));

        MeasureInfo measureInfo = null;
        measureInfo =new MeasureInfo(new Long(Calendar.getInstance().getTime().getTime()), val /*Double.parseDouble(value)*/);
