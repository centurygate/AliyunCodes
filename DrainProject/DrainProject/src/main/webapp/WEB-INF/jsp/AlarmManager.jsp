...
<div class="col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row" id="contentcrumb">
        <ol class="breadcrumb">
            <li><a href="#"><svg class="glyph stroked sound on"><use xlink:href="#stroked-sound-on"></use></svg></a></li>
            <li class="active">消息警报</li>
        </ol>
    </div><!--/.row-->
    <hr/> <!--分割横线-->
...
<%--lobi plugin(暂时取消这个插件-因为造成网页加载明显变慢)--%>
<%--<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/lobibox.min.css"/>--%>
...
<script src="${pageContext.request.contextPath}/static/js/AlarmManager-main.js"></script>
