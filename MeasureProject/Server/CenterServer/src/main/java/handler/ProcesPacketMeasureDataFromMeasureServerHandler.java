...
public class ProcesPacketMeasureDataFromMeasureServerHandler extends ChannelInboundHandlerAdapter
{
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception
	{
		if (msg instanceof PushMeasureDataMessage)
		{
			...
			SystemLog.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
			SystemLog.log("Received data from MeasureServer"+recvmsg);
			SystemLog.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
			...
			SystemLog.log("========================Data Persistance=================================");
			...
			HttpCliUtilForWebLaser.senddata("http://139.196.59.146:8080/WebLaserProject/service/rest/putdata?value=",measure);
