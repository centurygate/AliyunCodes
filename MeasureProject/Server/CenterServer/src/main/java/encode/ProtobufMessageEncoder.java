...
public class ProtobufMessageEncoder extends MessageToByteEncoder<Object>
{
	...
	protected void encode(ChannelHandlerContext ctx, Object msg, ByteBuf out) throws Exception
	{
		...
		//SystemLog.log("+++++++++++++++++ Encoding ClassType "+messageType+", ClassName:"+msg.getClass().getName()+" +++++++++++++++++");
		int packetLenth = 16;
		...
		{
			SystemLog.log("Tx--TotalLen: 0x"+Integer.toHexString(packetLenth)+"checksumLen: 0x"+Long.toHexString(checksum.getValue()));
//			SystemLog.log("checksum = "+checksum.getValue());
		}
		ctx.flush();
	}
}
